...
class CircularQueueOneSlotEmpty:
    ...
    def __init__(self,capacity):
        ...
        self.N = self.capacity + 1 # 내부 배열 크기 (한 칸 비움)
    ...
    def if_full(self):
        return self.front == (self.rear + 1) % self.N   #front가 rear 다음에 있으면 포화상태
    ...
    def dequeue(self):
        if not self.empty():
            ...
            item = self.array[self.front]   # 변환할 항목
    ...
    def size(self): # 현재 원형 큐에 저장된 요소의 총 개수 변환
